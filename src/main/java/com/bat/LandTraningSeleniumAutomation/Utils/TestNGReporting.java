...
public class TestNGReporting implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		File desfile = new File("C:\\Users\\Dell\\eclipse-workspace\\LandTraningSeleniumAutomation\\seleniumss.png");
		...
		System.out.println("Screen shot of failed page are taken...... ");
	}
